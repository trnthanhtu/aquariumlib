...
$("body").append('<img src="' + image.attr('src') + '.htm-" id="temp" style="position: absolute; z-index:9999; top:'+image_offset.top+'px; left:'+image_offset.left+'px" />');
...
function addToCart(product_id) {
	if (fl2) {
		...
		$('<img src="' + $('.htm#img_'+product_id).attr('src') + '-" id="temp" style="position: absolute; z-index:9999; top: ' + image.top + 'px; left: ' + image.left + 'px;" />').appendTo('body');
		params = {
		top : cart.top + 'px',
		left : cart.left + 'px',
		opacity : 0.2,
